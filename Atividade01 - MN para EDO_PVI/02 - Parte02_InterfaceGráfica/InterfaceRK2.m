%%       INTERFACE PARA O MÉTODO DE RUNGE - KUTTA DE ORDEM 2 (RK2)
%
...
disp('---------------------------------------------------------')
disp(' ')
disp('  MÉTODO DE RUNGE - KUTTA DE ORDEM 2 PARA RESOLUÇÃO DE  ')
...
%% Associação dos valores do PVI aos dados necessários para o M_RK2
...
%% Implemtação da função para resolução de EDO/PVI pelo M_RK2 e calculo da S_Exata
